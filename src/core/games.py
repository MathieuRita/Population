...
class ReferentialGame(nn.Module):
    ...
    def game_instance(self,
        ...
        distractors_embedding = distractors_embedding.reshape((batch_size,n_distractors,distractors_embedding.size(-1)))
...
class ImitationReconstructionGame(nn.Module):

    def __init__(self,
                 population:object):

        super(ImitationReconstructionGame, self).__init__()
        self.population = population
